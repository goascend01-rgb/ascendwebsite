    ...
    <>
            ...
            {SECURITY_SECTIONS.map((section, i) => (
              <RevealItem key={section.title} className="h-full">
                <article className="flex h-full flex-col rounded-lg border border-border-line bg-surface-1 p-7">
                  ...
                  <p className="mt-5 text-[0.95rem] leading-[1.72] font-light text-fg-secondary">
                    {section.body}
                  </p>
                </article>
              </RevealItem>
      ...
      <section className="py-20 md:py-24">
        <div className="shell">
          <SectionHeader
            label="// Subprocessors"
            title={<>Four vendors may touch patient data. Four is the whole list.</>}
          ...
          <Reveal delay={0.16}>
            <p className="mt-6 max-w-[64ch] text-[0.88rem] leading-[1.7] font-light text-fg-tertiary">
          ...
          <Reveal delay={0.2}>
            <div className="mt-12 rounded-lg border border-border-line bg-bg p-7 md:p-8">
              <p className="max-w-[68ch] text-[0.94rem] leading-[1.72] font-light text-fg-secondary">
              ...
              <p className="mt-5 text-[0.88rem] leading-[1.7] font-light text-fg-tertiary">
